package kimch321.spring.semiprojectv7.utils;
...
public class PdsUtils {
    ...
    // 첨부파일 저장 위치
    // 프로퍼티 파일에서 정의된 속성 이름 saveDir. @Value 어노테이션은 해당 속성 값을
    // 가져와서 주입해줍니다. saveDir 속성은
    // 외부 설정 파일(e.g., application.properties 또는 application.yml)에
    // 정의되어 있어야 합니다.
